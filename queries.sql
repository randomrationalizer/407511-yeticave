...
INSERT INTO `lot` (`start_date`, `name`, `description`, `img_path`, `start_price`, `end_date`, `step`, `author_id`, `winner_id`, `category_id`)     VALUES 
    ('2019-02-12 18:40:53', '2014 Rossignol District Snowboard', 'В отличном состоянии. Берите, не пожалеете!', 'img/lot-1.jpg', 10999, '2019-02-25 00:00:00', 100, 1, NULL, 1),
    ...
    ('2019-02-02 22:51:02', 'Крепления Union Contact Pro 2015 года размер L/XL', 'Не подошли.', 'img/lot-3.jpg', 8000, '2019-03-01 00:00:00', 50, 3, NULL, 1),
